            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="mx-auto mt-12 grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 sm:mt-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
                    {displayFeatures.map((feature, index) => (
                        <div
                            key={index}
                            className="relative flex flex-col gap-6 rounded-2xl border border-gray-200 bg-white p-8 shadow-sm transition-all hover:shadow-md"
                        >
                            {/* Icon */}
                            ...
                            <div className="absolute inset-0 -z-10 rounded-2xl transition-colors group-hover:bg-gray-50/75" />
                        </div>
                    ))}
                </div>
            </div>
