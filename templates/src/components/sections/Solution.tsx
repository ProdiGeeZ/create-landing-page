            ...
            <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
                <div className="grid gap-x-12 gap-y-8 lg:grid-cols-2">
                    ...
                    <div className="relative lg:mt-0">
                        <div className="aspect-[4/3] overflow-hidden rounded-xl bg-gray-50 shadow-lg">
                            <div className="absolute inset-0 flex items-center justify-center p-8">
                                {/* Preview Window */}
                                <div className="w-full space-y-6 rounded-lg bg-white p-6 shadow-sm ring-1 ring-gray-900/5">
                                    {/* Stats Grid */}
                        ...
                        {/* Decorative Elements */}
                        <div className="absolute -bottom-6 -left-6 h-24 w-24 rounded-full bg-primary/5 lg:-left-12" />
                        <div className="absolute -top-6 -right-6 h-24 w-24 rounded-full bg-primary/5 lg:-right-12" />
                    </div>
                </div>
            </div>
        </section>
