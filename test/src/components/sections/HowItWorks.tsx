        ...
        <section id="how-it-works" className="relative isolate overflow-hidden py-16 sm:py-24 lg:py-32">
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    {steps.map((step, index) => (
                        ...
                        >
                            ...
                            <div className="relative">
                                ...
                                <p className="mt-4 text-primary-foreground dark:text-base leading-7">
                                    {step.description}
                                </p>
                            </div>
                ...
                <div className="mt-12 flex justify-center sm:mt-16">
                    <a
                        href="#"
                        className="inline-flex text-primary-foreground items-center justify-center rounded-lg bg-primary px-6 py-3 
