...
export function FAQClient({ faqs }: FAQClientProps) {
    ...
    return (
        <div className="mx-auto mt-12 max-w-3xl divide-y divide-border dark:divide-border">
            {faqs.map((faq, index) => (
                <div key={index} className="py-6">
                    ...
                    >
                        <span className="text-base font-semibold leading-7 text-foreground dark:text-foreground">
                            {faq.question}
                        </span>
